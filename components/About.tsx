      ...
      <section className="desktop:pt-28  flex flex-col lg:flex-row justify-between relative z-10">
        ...
        <div className="flex flex-col justify-end gap-48 relative max-lg:mt-8">
          ...
          <div className="sm:ml-10  lg:ml-24 desktop:ml-0 relative  largesceen:mt-20">
            <h3 className="text-3xl sm:text-[1.75rem] desktop:text-4xl largesceen:text-[3.125rem] text-white-100 tracking-[0.094rem] mb-8 w-fit capitalize">
              High quality
            </h3>
            ...
            <Image
              src={labela}
              alt="label"
              className="absolute w-[5.313rem] lg:hidden top-1 right-6  label"
            />
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between items-center">
          ...
          <div className="w-48 h-48  hidden xl:block">
            <a
              href="#rooms"
              className="flex items-center justify-center text-white-100 no-underline w-full h-full"
            >
              <object
                type="image/svg+xml"
                data="/Polygon 2.svg"
                className="xl:w-[8.375rem] largesceen:w-[12.5rem]"
              >
                Your browser does not support SVGs
              </object>
              <p className="absolute  text-white-100  text-sm ">
                <span className="text-secondary"> Rooms</span> <br />{" "}
                <span className="inline-block ml-4">and</span> <br /> apartments{" "}
                <Image
                  src={vector2}
                  alt="vector down"
                  className="block mx-auto mt-6 h-[13px] largesceen:h-full"
                />
              </p>
            </a>
          </div>
