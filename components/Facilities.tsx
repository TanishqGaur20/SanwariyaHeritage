    ...
    <main data-aos="fade-up" data-aos-delay="0" data-aos-offset="150" data-aos-easing="ease-in-sine" data-aos-duration="400" className="bg-white-100  w-full h-full">
        ...
        <div className="flex flex-col justify-between sm:ml-16 desktop:ml-10 largesceen:ml-0">
          ...
          <div>
            <p className="text-gradient text-[0.813rem] desktop:text-base 2xl:text-lg leading-[155.556%] w-[13.813rem] sm:w-[70%] lg:w-[250px] desktop:w-[20.938rem] text-opacity-[0.8] max-sm:mt-12 xs:ml-[35%] sm:ml-0">
              We offers you a wide range of additional services and facilities. Visit our restaurant to try exclusive meals, book a conference hall to organize a business meeting, or relax in
              the art-bar.
            </p>
          </div>
        </div>
      ...
      <section
        ...
        <div>
          ...
          <p className="text-gradient text-[0.813rem] desktop:text-base 2xl:text-lg leading-[155.556%] w-[83%] sm:w-[70%] lg:w-[250px] desktop:w-[27.625rem] text-opacity-[0.8] mb-8 sm:mb-0">
            Dive into relaxation in our luxurious pool and wellness area. Enjoy a refreshing swim, unwind in the jacuzzi, or simply lounge by the water in a serene atmosphere designed for your comfort.
          </p>
        </div>

        <div>
          <Image src='https://www.gannett-cdn.com/presto/2019/02/27/USAT/52c2114d-9f01-48b4-b9fd-0f29fb4bd542-ang_Oceanfront_Infinity_Pool_at_Anguillas_Zemi_Beach_House_Hotel__Spa_is_the_go-to_for_relaxation_Credit_Dylan_Cross_Tambourine.jpg?crop=3999,2249,x0,y303&width=3200&height=1680&fit=bounds' width={500} height={500} alt="pool" className="lg:w-[22.25rem] desktop:w-[28.313rem] largesceen:w-[37.5rem] h-[26.5rem] largesceen:h-full object-cover" priority />
        </div>
      </section>
