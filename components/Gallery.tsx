...
const Gallery = () => {
  const quotes = [
    {
      quote:
        "Sanwariya Resort and Heritage  Sanwariya Resort and Heritage  Sanwariya Resort and Heritage  Sanwariya Resort and Heritage  Sanwariya Resort and Heritage  Sanwariya Resort and Heritage  Sanwariya Resort and Heritage  Sanwariya Resort and Heritage ",
    },
  ];
  return (
    <main className="bg-primary py-12 small:pt-32 lg:py-24 pt-24 sm:pt-36 lg:pt-48 desktop:pt-60 2xl:pt-72 largesceen:pt-80 ">
      ...
      <p className=" text-white-100 text-[0.813rem]  leading-[155.556%] w-[85%]  text-opacity-[0.8] text-center block mx-auto my-8 sm:hidden">
        The five-star Bank Hotel was reopened to visitors in 2016. The building
        was renovated and modernized to meet the expectations of the most
      ...
      <section className="flex pt-8 sm:pt-16 justify-between">
        <div className="flex flex-col justify-between">
          <Image
            ...
            alt="Gallery-Image 1"
            className="max-sm:w-[95%] lg:w-[10.125rem] xl:w-[13rem] desktop:w-[16rem] 2xl:w-[17rem] largesceen:w-[19.5rem]"
            priority
          />
          <Image
            src="/ccd-cheng-chung-design-hualuxe-xi-an-hi-tech-zone-architonic-20-qiu-xin-10-arcit18 1.png"
            priority
            alt="Gallery-Image 2"
        ...
        <div className="">
          ...
          <Image
            src="/space-copenhagen-the-stratford-architonic-jw-8-18-arcit18 1.png"
            priority
            alt="Gallery image 3"
        ...
        <div className="flex flex-col justify-between items-end relative">
          <Image
            src="/space-copenhagen-the-stratford-architonic-jw-2-16-arcit18 1.png"
            priority
            alt="gallery-4 image"
            className="max-sm:w-[95%]  lg:w-[10.125rem] xl:w-[13rem] desktop:w-[16rem] 2xl:w-[17rem] largesceen:w-[20.125rem] relative max-sm:top-4"
          />
          <Image
            src="/space-copenhagen-the-stratford-architonic-rs-4-26-arcit18 1.png"
            priority
            alt="gallery-5 image"
